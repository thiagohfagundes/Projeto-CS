...
from . import views
from .views import ListarClientes, AdicionarCliente, DetalhesCliente, EditarCliente, DeletarCliente
...
urlpatterns = [
    ...
    path('cliente/<int:pk>/deletar/', DeletarCliente.as_view(), name='deletar_cliente'),
]